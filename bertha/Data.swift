    ...
    init(context: NSManagedObjectContext) {
        ...
        if (challenges.count != 10 && concepts.count != 10) {
            self.concepts = [
                ...
                Concept(title: "Bertha Lutz", description: "Bertha Maria Julia Lutz (1894 - 1976) foi uma ativista pelo feminismo, bióloga e política brasileira. Foi ela a líder do movimento sufragista no Brasil, que refere-se às lutas realizadas a fim de conquistar o direito de participar das decisões políticas. \n\nQuer conhecer esta luta e descobrir por que, hoje, você tem o direito de votar?", context: context),
                Concept(title: "Igualdade de Gênero na Política", description: "Apesar das mulheres serem ao menos metade da população e dos eleitores, o imaginário comum continua a fazer acreditar que política é lugar para homens engravatados. \n\nRealize este desafio e entenda um pouco de como se comporta a política brasileira em relação às mulheres. Faça este desafio para entender o papel feminino na política.", context: context)
            ]
            ...
            self.challenges = [
                ...
                Challenge(description: "Leia o texto do Politize! sobre os três poderes (Executivo, Legislativo e Judiciário) e aprenda qual o papel de cada um deles e como se relacionam entre si. ", media: "http://www.politize.com.br/separacao-dos-tres-poderes-executivo-legislativo-e-judiciario/", image: #imageLiteral(resourceName: "tres-poderes"), concept: concepts[1], context: context),
                Challenge(description: "Leia o texto do Politize! e entenda as diferenças entre voto branco e nulo, bem como o impacto dos mesmos no resultado final do processo eleitoral. Boa leitura!", media: "http://www.politize.com.br/votos-brancos-e-nulos/", image: #imageLiteral(resourceName: "checking"), concept: concepts[2], context: context),
                Challenge(description: "Leia o texto do Politize! e descubra quem está apto ou não a assumir um cargo político.", media: "http://www.politize.com.br/inelegibilidade-cargo-politico/", image: #imageLiteral(resourceName: "inelegibilidade"), concept: concepts[3], context: context),
                Challenge(description: "Veja o infográfico do Politize! e aprenda como é feita uma pesquisa eleitoral, ou pesquisa de intenção de voto.", media: "http://www.politize.com.br/pesquisas-eleitorais-como-sao-feitas/", image: #imageLiteral(resourceName: "pesquisas"), concept: concepts[4], context: context),
                Challenge(description: "Leia o texto do Politize! sobre voto facultativo e descubra todas as razões de no nosso país termos o voto obrigatório.", media: "http://www.politize.com.br/voto-facultativo/", image: #imageLiteral(resourceName: "facultativo"), concept: concepts[5], context: context),
                Challenge(description: "Leia o texto do Politize! e conheça como o título de eleitor evoluiu ao longo da história política brasileira.", media: "http://www.politize.com.br/titulo-de-eleitor-tudo-que-voce-precisa-saber/", image: #imageLiteral(resourceName: "titulo"), concept: concepts[6], context: context),
                Challenge(description: "Leia o texto do Politize! e conheça as funções e responsabilidades de um presidente para que nas próximas eleições você possa dar o seu voto conciente.", media: "http://www.politize.com.br/presidente-da-republica-o-que-faz/", image: #imageLiteral(resourceName: "presidente"), concept: concepts[7], context: context),
                Challenge(description: "Leia o texto do Politize! e saiba como essas mulheres, lideradas por Bertha, conquistaram o direito ao voto no Brasil.", media: "http://www.politize.com.br/conquista-do-direito-ao-voto-feminino/", image: #imageLiteral(resourceName: "bertha-icon"), concept: concepts[8], context: context),
                Challenge(description: "Leia o texto do Politize! e entenda como a desigualdade de gênero no Brasil repercute também na presença feminina em posições de liderança política.", media: "http://www.politize.com.br/lugar-de-mulher-e-na-politica/", image: #imageLiteral(resourceName: "desigualdade-genero"), concept: concepts[9], context: context)

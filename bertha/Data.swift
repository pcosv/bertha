...
class Data {
    ...
    init(context: NSManagedObjectContext) {
        ...
        if (challenges.count != 10 && concepts.count != 10) {
            ...
            self.challenges = [
                Challenge(description: "Assista o filme \"As Sufragistas\", que narra a história das mulheres que enfrentaram seus limites na luta por igualdade e pelo direito de voto.", media: "https://www.youtube.com/watch?v=e88IJJv7PLQ", censura: 12, image: #imageLiteral(resourceName: "democracy"), concept: concepts[0], context: context),
                Challenge(description: "Assista o filme \"Mulher Maravilha\" e questione-se o porquê de existirem tão poucas super heroínas nas histórias em quadrinhos e no cinema. \nConverse com suas amigas sobre isso!", media: "https://www.youtube.com/watch?v=I6Gj8Fvukk4", censura: 0, image: #imageLiteral(resourceName: "womensvoice"), concept: concepts[1], context: context),
                Challenge(description: "Leia a Cartilha de Direitos Humanos do Ziraldo.\nApós a leitura, observe as pessoas ao seu redor: você acha que todas elas têm seus direitos garantidos?\nConverse com seus pais sobre isso.", media: "http://www.turminha.mpf.mp.br/multimidia/cartilhas/CartilhaZiraldodireitoshumanos.pdf/view", image: #imageLiteral(resourceName: "human-rights"), concept: concepts[2], context: context),
                Challenge(description: "Junte-se a sua melhor amiga para assistirem \"O Corajoso Coração de Irena Sendler\", filme que retrata a polonesa Irena Sendler, uma católica servidora social que salva milhares de crianças judias durante a Segunda Guerra Mundial.\nDepois da sessão, conversem sobre o filme.", media: "", censura: 14, image: #imageLiteral(resourceName: "ww2"), concept: concepts[3], context: context),
                ...
                Challenge(description: "Assista a este vídeo educativo para entender o que é e qual a responsabilidade exata do Poder Judiciário.\nComo você observa a atuação deste poder no seu país?", media: "https://www.youtube.com/watch?v=YMmR3LjweiQ", image: #imageLiteral(resourceName: "judiciario"), concept: concepts[7], context: context),

    ...
    init(context: NSManagedObjectContext) {
        ...
        if (challenges.count != 10 && concepts.count != 10) {
            ...
            self.challenges = [
                ...
                Challenge(description: "Leia o texto do Politize! e entenda as diferenças entre voto branco e nulo, bem como o impacto dos mesmos no resultado final do processo eleitoral. Boa leitura!", media: "http://www.politize.com.br/votos-brancos-e-nulos/", image: #imageLiteral(resourceName: "nulo-branco"), concept: concepts[2], context: context),
                ...
                Challenge(description: "Veja o infográfico do Politize! e aprenda como é feita uma pesquisa eleitoral, ou pesquisa de intenção de voto.", media: "http://www.politize.com.br/pesquisas-eleitorais-como-sao-feitas/", image: #imageLiteral(resourceName: "pesquisa"), concept: concepts[4], context: context),
                ...
                Challenge(description: "Leia o texto do Politize! e conheça como o título de eleitor evoluiu ao longo da história política brasileira.", media: "http://www.politize.com.br/titulo-de-eleitor-tudo-que-voce-precisa-saber/", image: #imageLiteral(resourceName: "titulo-eleitor"), concept: concepts[6], context: context),
                ...
                Challenge(description: "Leia o texto do Politize! e conheça as funções e responsabilidades de um governador para que nas próximas eleições você possa dar o seu voto conciente.", media: "http://www.politize.com.br/governador-o-que-faz/", image: #imageLiteral(resourceName: "governador"), concept: concepts[8], context: context),

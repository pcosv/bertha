    ...
    init(context: NSManagedObjectContext) {
        ...
        if (challenges.count != 10 && concepts.count != 10) {
            ...
            self.challenges = [
                ...
                Challenge(description: "Assista o filme \"Mulher Maravilha\" e questione-se o porquê de existirem tão poucas super heroínas nas histórias em quadrinhos e no cinema. \nConverse com suas amigas sobre isso!", media: "https://www.youtube.com/watch?v=I6Gj8Fvukk4", censura: 0, image: #imageLiteral(resourceName: "Representatividade"), concept: concepts[1], context: context),
                Challenge(description: "Leia a Cartilha de Direitos Humanos do Ziraldo.\nApós a leitura, observe as pessoas ao seu redor: você acha que todas elas têm seus direitos garantidos?\nConverse com seus pais sobre isso.", media: "http://www.turminha.mpf.mp.br/multimidia/cartilhas/CartilhaZiraldodireitoshumanos.pdf/view", image: #imageLiteral(resourceName: "Direitos Humanos"), concept: concepts[2], context: context),
                Challenge(description: "Junte-se a sua melhor amiga para assistirem \"O Corajoso Coração de Irena Sendler\", filme que retrata a polonesa Irena Sendler, uma católica servidora social que salva milhares de crianças judias durante a Segunda Guerra Mundial.\nDepois da sessão, conversem sobre o filme.", media: "", censura: 14, image: #imageLiteral(resourceName: "Segunda Guerra Mundial"), concept: concepts[3], context: context),
                Challenge(description: "Assista \"Casa Grande\", que conta a história de uma rica família brasileira que está a beira da falência.", media: "https://www.youtube.com/watch?v=lVxMtz0p0-k", censura: 14, image: #imageLiteral(resourceName: "Desigualdade Social"), concept: concepts[4], context: context),
                Challenge(description: "Assista a este vídeo educativo para entender o que é e qual a responsabilidade exata do Poder Executivo.\nVocê acha que os representantes políticos de sua cidade cumprem o dever a eles atribuídos?", media: "https://www.youtube.com/watch?v=OUxccIvFnMM", image: #imageLiteral(resourceName: "Poder Executivo"), concept: concepts[5], context: context),
                Challenge(description: "Assista a este vídeo educativo para entender o que é e qual a responsabilidade exata do Poder Legislativo.\nVocê acha que os representantes políticos de sua cidade cumprem o dever a eles atribuídos?", media: "https://www.youtube.com/watch?v=Ip9DC_StPUg", image: #imageLiteral(resourceName: "Poder Legislativo"), concept: concepts[6], context: context),
                Challenge(description: "Assista a este vídeo educativo para entender o que é e qual a responsabilidade exata do Poder Judiciário.\nComo você observa a atuação deste poder no seu país?", media: "https://www.youtube.com/watch?v=YMmR3LjweiQ", image: #imageLiteral(resourceName: "Poder Judiciário"), concept: concepts[7], context: context),
                Challenge(description: "Assista \"Estrelas Além do Tempo\", filme que conta a história de uma equipe de cientistas mulheres, na NASA, que teve grande participação na vitória norte americana em cima dos russos na corrida espacial.", media: "https://www.youtube.com/watch?v=wx3PVtrU-Os", censura: 0, image: #imageLiteral(resourceName: "Guerra Fria"), concept: concepts[8], context: context),
                Challenge(description: "Assista Tempos Modernos, filme que mostra a rotina de um operário numa linha de montagem e suas dificuldades.", media: "https://www.youtube.com/watch?v=FNv7M-UPNuY", censura: 0, image: #imageLiteral(resourceName: "Revolução Industrial"), concept: concepts[9], context: context)
